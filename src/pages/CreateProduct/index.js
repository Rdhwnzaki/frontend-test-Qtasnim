...
function CreateProduct() {
  ...
  const handleData = async (e) => {
    ...
    axios
      .post("http://localhost:3000/products/post-product", data)
      .then((res) => {
        console.log(res);
        Swal.fire("Success", "Tambah data barang success", "success");
        navigate("/home");
      })
      .catch((err) => {
        console.log(err);
        Swal.fire("Warning", "Tambah data barang failed", "error");
      });
  };
  return (
    <>
